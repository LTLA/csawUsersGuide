...
<<rmchecker, fig.small=TRUE, fig.asp=1>>=
...
FastQ files were obtained from the Sequence Read Archive (SRA) with accessions of SRR074398 for \file{es_1.bam}, SRR074399 for \file{es_2.bam}, SRR074417 for \file{tn_1.bam}, SRR074418 for \file{tn_2.bam} and SRR074401 for \file{input.bam}.

The paired-end dataset used in Section~\ref{data:pet} is available from NCBI GEO using the accession GSE43212 \cite{pal2013}.
The relevant FastQ file was obtained from the SRA with the accession SRR642390 for \file{example-pet.bam}.

All libraries used in Section~\ref{data:ccf} are available from NCBI GEO using the accession GSE31233 \cite{zhang2012}.
FastQ files were obtained from the SRA with the accessions SRR330784 and SRR330785 for \file{h3ac.bam}; SRR330800 and SRR330801 for \file{h3k4me2.bam}; and SRR330814, SRR330815 and SRR330816 for \file{h3k27me3.bam}. 
...
FastQ files were obtained from the SRA with the accessions SRR499732 and SRR499733 for \file{h3k4me3_pro.bam}, and SRR499716 and SRR499717 for \file{h3k4me3_mat.bam}. 
