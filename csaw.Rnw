...
ac.demo2 <- normOffsets(ac.demo2, type="loess")
...
By default, the offsets are stored in the \code{RangedSummarizedExperiment} object as an extra entry in the \code{assays} slot.
