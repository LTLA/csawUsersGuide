...
\begin{center}
\includegraphics{plots-ug/ug-023}
\end{center}
...
\begin{center}
\centering
\includegraphics{plots-ug/ug-027}
\end{center}
...
\setkeys{Gin}{width=0.7\textwidth}
\begin{center}
\includegraphics{plots-ug/ug-030}
\end{center}
...
\setkeys{Gin}{width=0.7\textwidth}
\begin{center}
\includegraphics{plots-ug/ug-034}
\end{center}
...
\setkeys{Gin}{width=0.7\textwidth}
\begin{center}
\includegraphics{plots-ug/ug-045}
\end{center}
...
\begin{center}
\includegraphics{plots-ug/ug-060}
\end{center}
...
\setkeys{Gin}{width=0.98\textwidth}
\begin{center}
\includegraphics{plots-ug/ug-064}
\end{center}
...
\end{Sinput}
\begin{Soutput}
GRanges object with 1614 ranges and 0 metadata columns:
         seqnames                 ranges strand
            <Rle>              <IRanges>  <Rle>
     ...
     ...      ...                    ...    ...
  [1610]     chrX [ 75514251,  75514260]      *
  [1611]     chrX [ 76599001,  76599110]      *
  [1612]     chrX [100494251, 100494310]      *
  [1613]     chrX [102157051, 102157060]      *
  [1614]     chrX [143482951, 143483160]      *
  -------
  seqinfo: 66 sequences from an unspecified genome
\end{Soutput}
\end{Schunk}
...
\begin{center}
\includegraphics{plots-ug/ug-114}
\end{center}
...
other attached packages:
 [1] Gviz_1.15.0                             
 [2] rtracklayer_1.31.3                      
 [3] org.Mm.eg.db_3.2.3                      
 [4] RSQLite_1.0.0                           
 [5] DBI_0.3.1                               
 [6] TxDb.Mmusculus.UCSC.mm10.knownGene_3.2.2
 [7] GenomicFeatures_1.23.15                 
 [8] AnnotationDbi_1.33.5                    
 [9] edgeR_3.13.4                            
[10] limma_3.27.7                            
[11] csaw_1.5.9                              
[12] SummarizedExperiment_1.1.13             
[13] Biobase_2.31.3                          
[14] GenomicRanges_1.23.9                    
...
loaded via a namespace (and not attached):
 ...
 [5] Rsamtools_1.23.1             Biostrings_2.39.6           
 [7] digest_0.6.9                 mime_0.4                    
 [9] R6_2.1.1                     plyr_1.8.3                  
[11] acepack_1.3-3.3              BiocInstaller_1.21.2        
[13] httr_1.0.0                   ggplot2_2.0.0               
[15] zlibbioc_1.17.0              rpart_4.1-10                
[17] splines_3.3.0                BiocParallel_1.5.12         
[19] statmod_1.4.23               Rhtslib_1.3.2               
[21] AnnotationHub_2.3.10         stringr_1.0.0               
[23] foreign_0.8-66               RCurl_1.95-4.7              
[25] biomaRt_2.27.2               munsell_0.4.2               
[27] shiny_0.12.2                 httpuv_1.3.3                
[29] htmltools_0.3                nnet_7.3-11                 
[31] gridExtra_2.0.0              interactiveDisplayBase_1.9.0
[33] Hmisc_3.17-1                 matrixStats_0.50.1          
[35] XML_3.98-1.3                 GenomicAlignments_1.7.10    
[37] bitops_1.0-6                 xtable_1.8-0                
[39] gtable_0.1.2                 magrittr_1.5                
[41] scales_0.3.0                 KernSmooth_2.23-15          
[43] stringi_1.0-1                XVector_0.11.2              
[45] latticeExtra_0.6-26          Formula_1.2-1               
[47] RColorBrewer_1.1-2           ensembldb_1.3.11            
[49] tools_3.3.0                  dichromat_2.0-0             
[51] BSgenome_1.39.1              survival_2.38-3             
[53] colorspace_1.2-6             cluster_2.0.3               
[55] VariantAnnotation_1.17.17   
\end{Soutput}
\end{Schunk}
