...
\textit{Last compiled:} 19 January 2019
\end{abstract}

\packageVersion{csaw 1.17.4}
...
## 1   SRR074398 NF-YA ESC (1) /tmp/RtmpUINiXA/file715d7c566625/SRR074398.bam
## 2   SRR074399 NF-YA ESC (2) /tmp/RtmpUINiXA/file715d7c566625/SRR074399.bam
## 3   SRR074417  NF-YA TN (1) /tmp/RtmpUINiXA/file715d7c566625/SRR074417.bam
## 4   SRR074418  NF-YA TN (2) /tmp/RtmpUINiXA/file715d7c566625/SRR074418.bam
## 5   SRR074401         Input /tmp/RtmpUINiXA/file715d7c566625/SRR074401.bam
\end{verbatim}
\begin{alltt}
...
\end{alltt}
\begin{verbatim}
## [1] "/tmp/RtmpUINiXA/file715d7c566625/SRR074398.bam"
## [2] "/tmp/RtmpUINiXA/file715d7c566625/SRR074399.bam"
## [3] "/tmp/RtmpUINiXA/file715d7c566625/SRR074417.bam"
## [4] "/tmp/RtmpUINiXA/file715d7c566625/SRR074418.bam"
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##                                                        Path
##                                                 <character>
## 1    /tmp/RtmpUINiXA/file715d25b4e843/h3k4me3-proB-8110.bam
## 2    /tmp/RtmpUINiXA/file715d25b4e843/h3k4me3-proB-8115.bam
## 3 /tmp/RtmpUINiXA/file715d25b4e843/h3k4me3-matureB-8070.bam
## 4 /tmp/RtmpUINiXA/file715d25b4e843/h3k4me3-matureB-8088.bam
\end{verbatim}
\begin{alltt}
...
##                                                       Path
##                                                <character>
## 1    /tmp/RtmpUINiXA/file715d2c21eada/h3k9ac-proB-8113.bam
## 2    /tmp/RtmpUINiXA/file715d2c21eada/h3k9ac-proB-8108.bam
## 3 /tmp/RtmpUINiXA/file715d2c21eada/h3k9ac-matureB-8059.bam
## 4 /tmp/RtmpUINiXA/file715d2c21eada/h3k9ac-matureB-8086.bam
\end{verbatim}
\begin{alltt}
...
## 7          3         3          0 0.000354344776491868 0.00450287251062473
## 19         4         4          0 0.000831695416857529 0.00715752134982737
## 24         4         4          0    0.084562340456042   0.144688162055889
## 26         4         0          0      0.8665376697912    0.89687371110087
## 29         3         3          0 0.000553807968763198 0.00568995137646539
## 37         4         4          0   0.0163475284799344  0.0472696997829639
##      direction
##    <character>
## 7           up
## 19          up
...
##    nWindows  logFC.up logFC.down             PValue                FDR
##   <integer> <integer>  <integer>          <numeric>          <numeric>
## 1         1         1          0 0.0222371328049001 0.0601814467180232
## 2         6         6          0  0.063040469764802  0.123599470352661
## 3         3         3          0 0.0268570682027511 0.0679163624317146
## 4         3         3          0  0.102465783196559  0.174905974936598
## 5         1         1          0 0.0146023514325386 0.0450959801719733
## 6         2         2          0  0.260094148644719  0.352167795034221
##     direction
##   <character>
## 1          up
## 2          up
...
## 19   3.13982804061885    8259301
## 24   1.43472431463571   92934601
## 26 -0.481129335439545   71596001
## 29   3.19449403596054    4137001
## 37   1.63806823230666  100187601
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{cons.win} \hlkwb{<-} \hlkwd{consolidateWindows}\hlstd{(}\hlkwc{data.list}\hlstd{=}\hlkwd{list}\hlstd{(ac.small, ac.large),}
    \hlkwc{equiweight}\hlstd{=}\hlnum{TRUE}\hlstd{,} \hlkwc{merge.args}\hlstd{=}\hlkwd{list}\hlstd{(}\hlkwc{tol}\hlstd{=}\hlnum{1000}\hlstd{))}
\hlstd{cons.win}\hlopt{$}\hlstd{region}
\end{alltt}
\begin{verbatim}
...
\end{verbatim}
\begin{alltt}
\hlstd{cons.res} \hlkwb{<-} \hlkwd{consolidateTests}\hlstd{(}\hlkwc{id.list}\hlstd{=cons.win}\hlopt{$}\hlstd{id,}
    \hlkwc{result.list}\hlstd{=}\hlkwd{list}\hlstd{(mock.small, mock.large),}
    \hlkwc{weight.list}\hlstd{=cons.win}\hlopt{$}\hlstd{weight)}
\hlstd{cons.res}
\end{alltt}
\begin{verbatim}
...
##        nWindows  logFC.up logFC.down             PValue               FDR
##       <integer> <integer>  <integer>          <numeric>         <numeric>
## 1             2         0          1  0.261313516646624 0.989617173606933
## 2            13         6          4   0.48972743205153 0.996606563842107
## 3             7         1          1  0.369826351292431 0.996606563842107
## 4            18         5          6  0.844250607820552 0.998168715421028
## 5             7         2          2  0.439831266977957 0.996606563842107
## ...         ...       ...        ...                ...               ...
## 21722         5         1          2 0.0420264936983585 0.968406238726708
## 21723         1         0          1  0.149147776886821 0.986666526179761
## 21724         3         0          0  0.274719097651541 0.989617173606933
## 21725         4         2          0  0.758170083165169 0.998168715421028
## 21726         4         1          1  0.011742933653295 0.946898079531129
##         direction
##       <character>
## 1            down
## 2            down
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{cons.olap} \hlkwb{<-} \hlkwd{consolidateWindows}\hlstd{(}\hlkwc{data.list}\hlstd{=}\hlkwd{list}\hlstd{(ac.small, ac.large),}
    \hlkwc{equiweight}\hlstd{=}\hlnum{TRUE}\hlstd{,} \hlkwc{region}\hlstd{=broads)}
\hlstd{cons.broad} \hlkwb{<-} \hlkwd{consolidateOverlaps}\hlstd{(}\hlkwc{olap.list}\hlstd{=cons.olap}\hlopt{$}\hlstd{olap,}
    \hlkwc{result.list}\hlstd{=}\hlkwd{list}\hlstd{(mock.small, mock.large),}
    \hlkwc{weight.list}\hlstd{=cons.olap}\hlopt{$}\hlstd{weight)}
\hlstd{cons.broad}
\end{alltt}
\begin{verbatim}
## DataFrame with 24368 rows and 6 columns
##        nWindows  logFC.up logFC.down            PValue               FDR
##       <integer> <integer>  <integer>         <numeric>         <numeric>
## 1            11         2          2 0.668729060340718 0.996533125904792
## 2            NA        NA         NA                NA                NA
## 3            NA        NA         NA                NA                NA
## 4            NA        NA         NA                NA                NA
## 5            NA        NA         NA                NA                NA
## ...         ...       ...        ...               ...               ...
## 24364       103        31         27  0.54309746456102 0.996533125904792
## 24365        17         3          9 0.437573739443905 0.994837264364171
## 24366         5         1          2 0.702550453366712 0.996533125904792
## 24367        16         4          3 0.934611816657707 0.998024202568164
## 24368         8         2          3 0.866734127746895 0.996633189500054
##         direction
##       <character>
## 1           mixed
## 2              NA
...
## 19     10620   1.39821129233062  0.576529254835471  6.38118914299321
## 24       413  0.981084306115614  0.372636647518153   3.1325329558643
## 26     12753 -0.096208260364703 -0.110784753139787 0.029067316502803
## 29     11210   3.19449403596054 -0.638878311087708  17.0669754515381
## 37      3509   1.63806823230666 -0.170697692941698  7.81008539653676
##                  PValue                 FDR
##               <numeric>           <numeric>
## 7  0.000118114925497289  0.0021219686691453
## 19   0.0157050623040909  0.0466535890455085
## 24    0.084562340456042   0.147771584890213
## 26    0.865505096004326   0.886306585116588
## 29 0.000184602656254399 0.00279541165185233
## 37  0.00801699278542564  0.0300102072742979
\end{verbatim}
\begin{alltt}
...
\begin{verbatim}
## [1] ""                        ""                       
## [3] "Rrs1:+:3898"             "Rrs1:+:48,Adhfe1:+:2686"
## [5] "1700034P13Rik:+:3989"    "Ppp1r42:-:1612"
\end{verbatim}
\end{kframe}
\end{knitrout}
