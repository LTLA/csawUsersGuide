...
\end{alltt}
\end{kframe}\begin{adjustwidth}{0mm}{-\fltoffset}
\includegraphics[width=\maxwidth]{plots-ug/dispplot-1} \end{adjustwidth}\begin{kframe}\begin{alltt}
\hlkwd{plotQLDisp}\hlstd{(fit)}
\end{alltt}
\end{kframe}\begin{adjustwidth}{0mm}{-\fltoffset}
\includegraphics[width=\maxwidth]{plots-ug/dispplot-2} \end{adjustwidth}
\end{knitrout}
