...
Users should choose one of these filtering approaches for their analyses.
Different filters can also be combined for more stringency, though whether this is sensible depends on the situation.
