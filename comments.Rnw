...
As in \code{treat}, I think that the magnitude of the enrichment over background is more important than the significance of a non-zero enrichment.
...
The log-fold change threshold is more stable to the sequencing depth.
