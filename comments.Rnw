...
This shows up as reproducible differences in the TapeStation profiles (recall Alikesei's H3K27me3 data) and manifests most clearly in coverage across repeat regions where biases are amplified, e.g., mitochondria.
