...
If you have a mixture of NB distributions with different dispersions but the same mean, applying a stringent mean filter will select for higher dispersions.
